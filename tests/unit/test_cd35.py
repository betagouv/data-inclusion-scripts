...
@pytest.fixture
def cd35_input_file():
    return io.StringIO(CD35_ANNUAIRE_SOCIAL_SAMPLE)


def test_preprocess_cd35(cd35_input_file):
    df = cd35.transform_data(cd35.extract_data(cd35_input_file))
    ...
    assert df.to_dict(orient="records") == [
        {
            ...
            "courriel": "availes.maire@wanadoo.fr",
            "site_web": None,
